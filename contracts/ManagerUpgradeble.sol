...
contract ManagerUpgradeble is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    function _authorizeUpgrade(address newImplementation) internal override onlyOwner {
        // Upgrade authorization logic, typically access control.
        // `onlyOwner` modifier ensures only the contract owner can perform upgrades.
    }
